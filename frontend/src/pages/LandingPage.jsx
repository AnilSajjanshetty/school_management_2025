                                    ...
                                    <div className="relative bg-white/90 backdrop-blur-xl p-6 rounded-3xl shadow-xl border border-white/50">
                                        <div className="flex items-center gap-3 mb-4">
                                            ...
                                            <div>
                                                ...
                                                <p className="text-sm text-violet-600 font-semibold">{event.date}</p>
                                            </div>
                                        </div>
                        ...
                        <div className="grid md:grid-cols-3 gap-8">
                            {testimonials?.map((t, i) => (
                                ...
                                >
                                    ...
                                    <p className="italic text-gray-700 text-lg mb-6 leading-relaxed">"{t.message}"</p>
                                ...
                                >
                                    <div className="bg-white p-6 rounded-3xl h-full">
                                        <div className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-3">
                                            ...
                                            <span className="text-sm font-semibold text-pink-600">{a.date}</span>
                                        </div>
                                        <p className="mt-3 text-gray-600">{a.content}</p>
                                    </div>
                                </motion.div>
                            ))}
                        </div>
                                    ...
                                    <div className="bg-white p-6 sm:p-8 rounded-3xl space-y-6">
                                        <input
                                            ...
                                            className="
                                                w-full px-6 py-4 
                                                bg-gray-50 
                                                border-2 border-gray-300    /* Default border */
                                                rounded-2xl 
                                                ...
                                                transition-all
                                                bg-clip-padding
                                                [background:linear-gradient(white,white)_padding-box,
                                                linear-gradient(to_right,#8b5cf6,#ec4899)_border-box]
                                            "
                                            required
                                        />
                                        ...
                                        <motion.button
                                            ...
                                            whileTap={{ scale: 0.98 }}
                                            type="submit"
                                            className="w-full py-5 bg-gradient-to-r from-violet-600 to-pink-600 text-white rounded-2xl font-bold text-lg shadow-2xl relative overflow-hidden group"
                                        >
